...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    ret.steerActuatorDelay = 0.33  # kona ev delay
    ...
    if candidate in (CAR.SANTA_FE, CAR.SANTA_FE_2022, CAR.SANTA_FE_HEV_2022, CAR.SANTA_FE_PHEV_2022):
      ...
      ret.wheelbase = 2.6
      ret.steerRatio = 13.2 # https://www.hyundainews.com/assets/documents/original/34398-2019KonaEVSpecifications10418docx.pdf
      tire_stiffness_factor = 0.5
      ret.lateralTuning.torque.kf = 0.9 # overall turn multiplier
