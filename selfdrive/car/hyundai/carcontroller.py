...
class CarController:
  ...
  def update(self, VM, CC, sm, vcruise, CS, now_nanos):
    ...
    # print debug data
    sLogger.Send("0ac" + "{:.2f}".format(CS.out.aEgo) + " c" + "{:.1f}".format(CS.out.cruiseState.speed) + " v" + "{:.1f}".format(l0v * 2.23694) + " ta" + "{:.2f}".format(target_accel) + " pr" + str(int(CS.out.cruiseState.nonAdaptive)) + " ds" + "{:.1f}".format(desired_speed) + " dv" + "{:.2f}".format(l0v_distval_mph) + " vs" + "{:.2f}".format(l0vstd * 2.23694) + " ld" + "{:.1f}".format(l0d) + " ms" + "{:.1f}".format(avg_accel_min))
